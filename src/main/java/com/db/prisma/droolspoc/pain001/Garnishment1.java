...
public class Garnishment1 {
    ...
    private GarnishmentType1 tp;
    @XmlElement(name = "Grnshee")
    private PartyIdentification43 grnshee;
    @XmlElement(name = "GrnshmtAdmstr")
    private PartyIdentification43 grnshmtAdmstr;
    ...
    private Boolean fmlyMdclInsrncInd;
    @XmlElement(name = "MplyeeTermntnInd")
    private Boolean mplyeeTermntnInd;
